...
<head>
	...
	<title>Bayu Junis Pribadi Profile Website</title>
...
<body>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="footer-logo">
						<h3 style="color: #FFF; margin-top: 20px;">Find Me On</h3>
					</div>
					<!-- /footer logo -->

					<!-- footer follow -->
					<ul class="footer-follow">
						<li><a href="https://www.facebook.com/bayu.pribadi.9"><i class="fa fa-facebook"></i></a></li>
						<li><a href="https://twitter.com/BayuJunisP"><i class="fa fa-twitter"></i></a></li>
						<li><a href="https://plus.google.com/112867173614993531320"><i class="fa fa-google-plus"></i></a></li>
						<li><a href="https://instagram.com/bayujunisp"><i class="fa fa-instagram"></i></a></li>
						<li><a href="whatsapp://send?text=Hello!&phone=+6287785142920"><i class="fa fa-whatsapp"></i></a></li>
					</ul>
					<!-- /footer follow -->

					<!-- footer copyright -->
					<div class="footer-copyright">
						<p>Copyright bayujunisp ©2019. All Rights Reserved.</a></p>
					</div>
					<!-- /footer copyright -->
	...
	<script type="text/javascript" src="assets/js/bayuscript.js"></script>
