...
<!-- paste your html in here -->

</body>

<audio class="song" loop autoplay>
  <source src="./music/sempurna.mp3">
  </source>
...
<div class="container">
  ...
  <div class="five">
    <!-- <p class="idea-1">You Are The Light Of My Life(image Of Light)</p>
    <p class="idea-2"> Dunia Ini Memiliki Banyak Orang "Hebat" Kamu Salah Satunya   </p>
     --><p class="idea-3">
